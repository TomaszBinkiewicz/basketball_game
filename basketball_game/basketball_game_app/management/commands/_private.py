...
TEAMS = (
    ...
    ("Utah Jazz", 0, 0, 1),
    ("Denver Nuggets", 0, 0, 1),
    ("Phoenix Suns", 0, 0, 1),
    ("Sacramento Kings", 0, 0, 1),
    ("Houston Rockets", 0, 0, 1),
    ("Los Angeles Lakers", 0, 0, 1),
    ("Los Angeles Clippers", 0, 0, 1),
    ("Portland Trail Blazers", 0, 0, 1),
    ("Memphis Grizzlies", 0, 0, 1),
    ("San Antonio Spurs", 0, 0, 1),
    ("New Orleans Pelicans", 0, 0, 1),
    ("Dallas Mavericks", 0, 0, 1),
    ("Minnesota Timberwolves", 0, 0, 1),
    ("Oklahoma City Thunder", 0, 0, 1),
)


def create_teams():
    for team in TEAMS:
        Teams.objects.create(name=team[0], games_played=team[1], games_won=team[2], conference=team[3])
